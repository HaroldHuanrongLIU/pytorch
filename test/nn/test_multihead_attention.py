...
class TestMultiheadAttentionNNDeviceType(NNTestCase):
    ...
    def test_multihead_self_attn_two_masks_fast_path_mock(self, device):
        ...
        # when a fast-path support API becomes available. The native MHA fast
        # path (torch._native_multi_head_attention) is currently only
        # implemented for CPU, CUDA, XPU, and PrivateUse1 backends.

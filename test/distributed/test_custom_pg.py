...
class CustomProcessGroupTest(MultiProcessTestCase):
    ...
    def test_pg_bypass_extracts_group_positionally(self):
        ...
        dist.Backend.register_backend(
            "positional_bypass",
            lambda *args, **kwargs: _PositionalPG(args[0].group_rank, args[0].group_size),
            extended_api=True,
        )
    ...
    def test_passthrough_delegates_to_inner(self):
        ...
        dist.Backend.register_backend(
            "inner_terminal", create_inner, extended_api=True,
        )
        dist.Backend.register_backend(
            "outer_passthrough", create_outer, extended_api=True,
        )
    ...
    def test_passthrough_fallback(self):
        ...
        class _OuterPG(dist.distributed_c10d.PassthroughProcessGroup):
            def all_reduce(self, tensor, op=None, async_op=False):
                ...
                return self._inner_pg.all_reduce(
                    tensor, op=op, async_op=async_op,
                )
        ...
        dist.Backend.register_backend(
            "fb_inner", create_inner, extended_api=True,
        )
        dist.Backend.register_backend(
            "fb_outer", create_outer, extended_api=True,
        )
    ...
    def test_passthrough_kwargs_forwarding(self):
        ...
        class _InnerPG(dist.ProcessGroup):
            ...
            def broadcast(self, tensor, src=None, async_op=False,
                          group_src=None):
                calls.append(
                    {
                        "op": "inner_broadcast",
        ...
        class _OuterPG(dist.distributed_c10d.PassthroughProcessGroup):
            def broadcast(self, tensor, src=None, async_op=False,
                ...
                return self._inner_pg.broadcast(
                    tensor, src=src, async_op=async_op, **kwargs,
                )
        ...
        dist.Backend.register_backend(
            "kw_inner", create_inner, extended_api=True,
        )
        dist.Backend.register_backend(
            "kw_outer", create_outer, extended_api=True,
        )
    ...
    def test_passthrough_pg_options_dict(self):
        ...
        dist.Backend.register_backend(
            "opts_inner", create_inner, extended_api=True,
        )
        dist.Backend.register_backend(
            "opts_outer", create_outer, extended_api=True,
        )
    ...
    def test_passthrough_pg_options_non_dict(self):
        ...
        dist.Backend.register_backend(
            "ndopt_inner", create_inner, extended_api=True,
        )
        dist.Backend.register_backend(
            "ndopt_outer", create_outer, extended_api=True,
        )
    ...
    def test_nested_three_layers(self):
        ...
        dist.Backend.register_backend(
            "layer_inner", create_inner, extended_api=True,
        )
        dist.Backend.register_backend(
            "layer_middle", create_middle, extended_api=True,
        )
        dist.Backend.register_backend(
            "layer_outer", create_outer, extended_api=True,
        )
    ...
    def test_passthrough_custom_work(self):
        ...
        dist.Backend.register_backend(
            "work_inner", create_inner, extended_api=True,
        )
        dist.Backend.register_backend(
            "work_outer", create_outer, extended_api=True,
        )
    ...
    def test_passthrough_new_group_wraps_subgroup(self):
        ...
        def create_inner(dist_opts, pg_options=None):
            return _InnerPG(
                dist_opts.group_rank, dist_opts.group_size,
            )
        ...
        dist.Backend.register_backend(
            "ng_inner", create_inner, extended_api=True,
        )
        dist.Backend.register_backend(
            "ng_outer", create_outer, extended_api=True,
        )
